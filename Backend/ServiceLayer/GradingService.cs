...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    ...
    public class GradingService
    {
        ...
        {
            return serviceFactory.boardService.LimitColumn(email, boardName, columnOrdinal, limit);
        }
        ...
        {
            return serviceFactory.taskService.AddTask(email, boardName, title, description, dueDate);
        }
        ...
        {
            return serviceFactory.taskService.UpdateTaskDueDate(email, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return serviceFactory.taskService.UpdateTaskTitle(email, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return serviceFactory.taskService.UpdateTaskDescription(email, boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return serviceFactory.taskService.MoveTask(email, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return serviceFactory.boardService.GetColumn(email, boardName, columnOrdinal);
        }
        ...
        {
            return serviceFactory.userService.InProgressTasks(email);
        }
        ...
        {
            return serviceFactory.userService.GetUserBoards(email);
        }
        ...
        {
            return serviceFactory.boardService.AddUser(email, boardID);
        }
        ...
        {
            return serviceFactory.boardService.RemoveUser(email,boardID);
        }
        ...
        {
            return serviceFactory.taskService.AssignTask(email,boardName,columnOrdinal,taskID,emailAssignee);
        }
        ...
        {
            return serviceFactory.boardService.SetOwner(currentOwnerEmail,newOwnerEmail,boardName);
        }
    }
}
